...
AGATE,An ornamental stone consisting of a hard variety of chalony
...
CEDAR,A tall coniferous tree which has fragrant wood
...
export const useWordList = () => {
  return useMemo(() => {
    const lines = WORD_LIST_DATA.split('\n');
...
export const getWordOfTheDay = (words: Map<string, string>, dateKey: string): { solution: string, definition: string } => {
